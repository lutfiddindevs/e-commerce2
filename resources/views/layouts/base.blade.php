                    ...
                    <div class="topbar-menu right-menu">
                        <ul>
                            ...
                            @auth
                                ...
                                @else
                                    <li class="menu-item menu-item-has-children parent" >
                                        <a title="My Account" href="#">Dollar My Account ({{ Auth::user()->name }})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                        <ul class="submenu curency" >
                                            <li class="menu-item" >
...
<script src="https://cdn.tiny.cloud/1/0jptp10x5xev1fh54d6civ0rg3qi6tgskulbu5f1hnh5mqn9/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
@livewireScripts
@stack('scripts')
</body>
</html>
